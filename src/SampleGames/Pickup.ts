...
Pickup.addBoardPile({label: 'Deck', initialState: PileState.SHUFFLED, visibility: Visibility.FACE_DOWN });
Pickup.addBoardPile({label: 'Deck2', actionRoles: ['Deck'], initialState: PileState.SHUFFLED, visibility: Visibility.FACE_DOWN });
